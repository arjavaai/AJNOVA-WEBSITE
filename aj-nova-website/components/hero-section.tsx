...
export function HeroSection() {
  return (
    <section className="relative z-10 pt-40 pb-20 px-6 overflow-hidden min-h-screen flex items-center">
          ...
          <div className="mt-12 flex items-center gap-4 text-sm text-muted-foreground">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-10 h-10 rounded-full border-2 border-card bg-muted flex items-center justify-center text-xs overflow-hidden shadow-sm"
                >
                  <img
            ...
            <div>
              <p className="text-foreground font-bold">3,000+ Students</p>
              <p>Placed in top universities</p>
            </div>
          </div>
        </div>
